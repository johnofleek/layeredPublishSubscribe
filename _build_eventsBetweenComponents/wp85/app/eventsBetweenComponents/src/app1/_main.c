...
// Startup code for the executable 'app1'.
...
LE_SHARED const char* _appComponent_temperature_ServiceInstanceName = "app1.appComponent.temperature";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t app1_exe_LogSession;
LE_SHARED le_log_Level_t* app1_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    app1_exe_LogSession = log_RegComponent("app1_exe", &app1_exe_LogLevelFilterPtr);
