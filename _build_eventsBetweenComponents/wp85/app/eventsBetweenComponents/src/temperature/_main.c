...
// Startup code for the executable 'temperature'.
...
LE_SHARED const char* _temperatureComponent_temperature_ServiceInstanceName = "temperature.temperatureComponent.temperature";
LE_SHARED const char* _temperatureComponent_le_cfg_ServiceInstanceName = "temperature.temperatureComponent.le_cfg";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t temperature_exe_LogSession;
LE_SHARED le_log_Level_t* temperature_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    temperature_exe_LogSession = log_RegComponent("temperature_exe", &temperature_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_temperatureComponent.so");
