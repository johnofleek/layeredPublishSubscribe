...
// Startup code for the executable 'app2'.
...
LE_SHARED const char* _appComponent2_temperature_ServiceInstanceName = "app2.appComponent2.temperature";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t app2_exe_LogSession;
LE_SHARED le_log_Level_t* app2_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    app2_exe_LogSession = log_RegComponent("app2_exe", &app2_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_appComponent2.so");
