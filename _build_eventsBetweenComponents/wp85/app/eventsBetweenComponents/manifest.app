...
<app:application xmlns:app="http://www.sierrawireless.com/airvantage/application/1.0" name="eventsBetweenComponents" type="" revision="0.0.1">
  <application-manager use="LWM2M_SW"/>
  <capabilities>
    <communication use="legato"/>
    <data>
      <encoding type="LWM2M">
        <asset default-label="Application Objects" id="le_eventsBetweenComponents">
